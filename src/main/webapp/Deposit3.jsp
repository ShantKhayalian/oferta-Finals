                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="DepositClient" method="get" name="SortingPercentageDesc">
                            ...
                            <form action="DepositClient" method="get" name="SortingPercentageAsec">
                        ...
                        <div class="table-cell">
                            ...
                            <span>Գումար</span>
                            <form action="DepositClient" method="get" name="SortingPercentageDescAmount">
                            ...
                            <form action="DepositClient" method="get" name="SortingPercentageAsecAmount">
                                                ...
                                                <div class="table">
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-cell text-center last">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                    <a href="Credits?ProductCode=${firstDepo.productCode}&FromPageName=Deposit&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&range=<%=request.getAttribute("range")%>&&Currancy=<%=request.getParameter("Currancy")%>&&value_two=0&&months=1"
                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                        ավելին</a>
                                                                    <a href="DepositClient?id=${firstDepo.productCode}&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=Deposits&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                                ...
                                                                                <div class="table">
                                                                                    <div class="table-row">
                                                                                        ...
                                                                                        <div class="table-cell text-center">
                                                                                            ...
                                                                                            <c:choose>
                                                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                                    <a href="Credits?ProductCode=${seconDepo.productCode}&FromPageName=Deposit&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&range=<%=request.getAttribute("range")%>&&Currancy=<%=request.getParameter("Currancy")%>&&value_two=0&&months=1"
                                                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                                        ավելին</a>

                                                                                                    <a href="DepositClient?id=${seconDepo.productCode}&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=Deposits&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                                                    <%--<p>
