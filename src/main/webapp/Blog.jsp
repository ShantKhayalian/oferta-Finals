                         ...
                         <div class="tooltip">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="Blog" method="get" name="Delete">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="Blog" method="get" name="DeleteHipotek">
                            ...
                            <ul>
                                <li>
                                  ...
                                  <form action="Blog" method="get" name="DeleteConsumer">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="Blog" method="get" name="DeleteCar">
                           ...
                           <%-- <form action="CompareMicro" method="get" name="MicroCompare">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="Blog" method="get" name="DeleteAG">
                    ...
                    <c:if test="${requestScope.usefulArticlesList != null}">
                        <c:forEach items="${requestScope.usefulArticlesList}" var="blog">
                            <div class="col-4 margin-bottom-40">
                                <div class="faq-item">
                                    <a href="BlogsDetail?Blogid=${blog.UAId}&&Pagelanguage=${requestScope.Pagelanguage}&&Currancy=${requestScope.PageCurrancy}">
                                        <div class="item-img">
                                            <img width="250px"
