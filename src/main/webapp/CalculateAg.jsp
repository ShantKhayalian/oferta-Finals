                        ...
                        <div class="table">
                            <div class="table-row">
                                ...
                                <div class="table-cell">
                                    ...
                                    <c:set var="percentage" value="${SpecialConsumer.ACFactual}"
                                           scope="request"/>
                                ...
                                <div class="table-cell text-center">
                                    ...
                                    <p><a href="AgCalculate?id=${SpecialConsumer.productCode}&&months=<%=request.getParameter("months")%>&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getParameter("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                          class="blue-link font-12 linkScrollDown">Համեմատել</a>
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="AgCalculate" method="get" name="SortingPercentageDesc">
                            ...
                            <form action="AgCalculate" method="get" name="SortingPercentageAsec">
                           ...
                           <%-- <c:set value="${requestScope.arrow2}" var="arrow2"/>
                            <c:choose>
                                <c:when test="${arrow2 == 0}">
                                   &lt;%&ndash; <i class="icon-polygon-down active"></i>
                                    <i class="icon-polygon-up " onclick="document.SortingTimeDescAmount.submit();"></i>&ndash;%&gt;
                                    <i class="icon-polygon-down "
                                       onclick="document.SortingPercentageDesc.submit();"></i>
                                    <i class="icon-polygon-up active "></i>
                                </c:when>
                                <c:otherwise>
                                  &lt;%&ndash;  <i class="icon-polygon-down "
                                       onclick="document.SortingTimeAsecAmount.submit();"></i>
                                    <i class="icon-polygon-up active "></i>&ndash;%&gt;
                                    <i class="icon-polygon-down active"></i>
                                    <i class="icon-polygon-up " onclick="document.SortingPercentageAsec.submit();"></i>
                            ...
                            <span>Գումար</span>
                            <%-- <form action="AgCalculate" method="get" name="SortingTimeDescAmount">
                             ...
                             <form action="AgCalculate" method="get" name="SortingTimeAsecAmount">
                                                    ...
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-cell">
                                                            ...
                                                            <h2 class="timer count-title count-number font-28 bold"
                                                                data-to="<%=calculatePercentageMain(Amount, percent, month)%>"
                                                                data-speed="1739"></h2>
                                                            </c:when>
                                                        ...
                                                        <div class="special-offer-item">
                                                            ...
                                                            <div>
                                                                <form action="Credits" method="get">
                                                                    ...
                                                                    <input type="hidden" name="PageToGo"
                                                                           value="Deposit"/>
