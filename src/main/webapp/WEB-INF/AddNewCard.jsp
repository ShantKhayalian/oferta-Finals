                        ...
                        <div class="header">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="cardPerMaxCashBack" class="form-control" step="0.01" min="0" max="200" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="cardGracePeriod" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="cardPerOnCreditStanding" class="form-control" required/>
