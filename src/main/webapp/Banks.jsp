            ...
            <div class="inner-container large">
                <div class="flex space-between">
                    <div class="left flex align-items-center">
							<span class="logo"> <a href="App"><imgimg src="../images/oferta1.jpg" alt=""/></a>
                         ...
                         <div class="tooltip">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="Ofbanks" method="get" name="Delete">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="Ofbanks" method="get" name="DeleteHipotek">
                            ...
                            <ul>
                                <li>
                                  ...
                                  <form action="Ofbanks" method="get" name="DeleteConsumer">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="Ofbanks" method="get" name="DeleteCar">
                           ...
                           <%-- <form action="CompareMicro" method="get" name="MicroCompare">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="Ofbanks" method="get" name="DeleteAG">
                ...
                <div class="col-9 left-side">
                    <%--<div class="top-calculator top-search bg-blue margin-bottom-30">
                        <div class="inner-container info-container">
                            <div class="row-md clearfix">
                                &lt;%&ndash;<form action="searchBanks" method="get">
                    ...
                    <div class="banner-box no-bg">
                        ...
                        <div class="inner">
                            <div class="text-box">
                                ...
                                <p>Հայտնի է, որ ընթերցողը, կարդալով հասկանալի տեքստ, չի կարողանա կենտրոնանալ տեքստի
                                    ձևավորման վրա</p>
        ...
        <div class="inner-container">
            ...
            <div class="tab-container">
                ...
                <div class="tab-content" id="mortgage">
                    <div class="top">
                        <a href="MortgageClient?Currancy=${requestScope.PageCurrancy}&&Amount=${dropDownList.minAmount}&&MaxAmounr=${dropDownList.maxAmount}" class="green-link width-icon"> <i
