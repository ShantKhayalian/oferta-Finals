        ...
        <div class="flex space-between align-items-center inner-content flex-wrap">
            ...
            <div class="nav-content">
                <ul>
                    ...
                    <li><a href="index.php?page=deposit">Ավանդներ</a></li>
                    <li><a href="index.php?page=hyperpox">Հիփոթեք</a></li>
                    <li><a href="index.php?page=consumer-loan">Սպառողական վարկեր</a></li>
                    <li><a href="index.php?page=car-loan">Ավտովարկ</a></li>
                    <li><a href="index.php?page=microcredit">Միկրովարկ</a></li>
                    <li><a href="index.php?page=agricultural-credit">Գյուղատնտեսական վարկ</a></li>
                    <li><a href="index.php?page=cards">Քարտեր</a></li>
                </ul>
            </div>
