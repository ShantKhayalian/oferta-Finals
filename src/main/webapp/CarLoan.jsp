                        ...
                        <div class="table">
                            <div class="table-row">
                                ...
                                <div class="table-cell text-center">
                                    ...
                                    <a href="CreditSend?ProductCode=${SpecialDeposit.productCode}&&range_two=<%=(int) request.getAttribute("range2")%>&&MaxAmount=<%=request.getParameter("MaxAmounr")%>&&percentageSecond=<%=percentageForDiscount2%>&&months=0&&PageToGo=Cars&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&Amount=<%=request.getAttribute("range")%>"
                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ ավելին</a>
                                    <p>
                                        <a href="AutoClient?id=${SpecialDeposit.productCode}&&percentageSecond=<%=percentageForDiscount2%>&&range_two=<%=ranger%>&&options=0&&months=1&&MaxAmount=<%=request.getAttribute("maxAmount")%>&&City=<%=request.getAttribute("city")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="AutoClient" method="get" name="SortingPercentageDesc">
                            ...
                            <form action="AutoClient" method="get" name="SortingPercentageAsec">
                        ...
                        <div class="table-cell">
                            ...
                            <span>Գումար</span>
                            <form action="AutoClient" method="get" name="SortingPercentageDescAmount">
                            ...
                            <form action="AutoClient" method="get" name="SortingPercentageAsecAmount">
                                                        ...
                                                        <div class="table-cell text-center last">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                    ...
                                                                    <a href="CreditSend?ProductCode=${firstDepo.productCode}&&range_two=<%=(int) request.getAttribute("range2")%>&&MaxAmount=<%=request.getParameter("MaxAmounr")%>percentageSecond=<%=percentageForDiscount2%>&&months=0&&PageToGo=Cars&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&Amount=<%=request.getAttribute("range")%>"
                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                        ավելին</a>
                                                                                ...
                                                                                <div class="table">
                                                                                    <div class="table-row">
                                                                                        ...
                                                                                        <div class="table-cell text-center">
                                                                                            ...
                                                                                            <c:choose>
                                                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                                    <a href="CreditSend?ProductCode=${seconDepo.productCode}&&range_two=<%=(int) request.getAttribute("range2")%>&&MaxAmount=<%=request.getParameter("MaxAmounr")%>percentageSecond=<%=percentageForDiscount2%>&&months=0&&PageToGo=Cars&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&Amount=<%=request.getAttribute("range")%>"
                                                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                                        ավելին</a>
