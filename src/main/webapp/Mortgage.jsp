            ...
            <div class="inner-container info-container">
                ...
                <div class="row-md clearfix">
                    <div class="col-3 large col">
                        <form name="main" action="CalculateMort" method="get">
                            ...
                            <div class="def-range">
                                ...
                                <c:if test="${requestScope.valueTwo == null}">
                                    <c:forEach items="${requestScope.dropDownsListWithCurrancy}"
                                        ...
                                        %>
                                        <%
                                            ranger = (int) request.getAttribute("range2");
                                        %>
                        ...
                        <div class="table">
                            <div class="table-row">
                                ...
                                <div class="table-cell text-center">
                                    ...
                                    <a href="CreditSend?ProductCode=${SpecialDeposit.productCode}&&range=<%=request.getAttribute("Amount")%>&&range_two=<%=(int) request.getAttribute("range2")%>&&percentageSecond=<%=percentageForDiscount2%>&&options=1&&months=1&&PageToGo=Mortgage&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>"
                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ ավելին</a>
                                    <p>
                                        <a href="MortgageClient?id=${SpecialDeposit.productCode}&&percentageSecond=<%=percentageForDiscount2%>&&range_two=<%=ranger%>&&options=0&&months=1&&MaxAmount=<%=request.getAttribute("maxAmount")%>&&City=<%=request.getAttribute("city")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                    ...
                                    <p>
                                        ...
                                        <a href="CreditSend?ProductCode=${SpecialDeposit.productCode}&&range=<%=request.getAttribute("Amount")%>&&range_two=<%=ranger%>&&percentageSecond=<%=percentageForDiscount2%>&&options=1&&months=1&&PageToGo=Mortgage&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>"
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="MortgageClient" method="get" name="SortingPercentageDesc">
                            ...
                            <form action="MortgageClient" method="get" name="SortingPercentageAsec">
                        ...
                        <div class="table-cell">
                            ...
                            <span>Գումար</span>
                            <form action="MortgageClient" method="get" name="SortingAmountDescAmount">
                            ...
                            <form action="MortgageClient" method="get" name="SortingAmountAsecAmount">
                                                        ...
                                                        <div class="table-cell text-center last">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                    ...
                                                                    <a href="CreditSend?ProductCode=${firstDepo.productCode}&&range=<%=request.getAttribute("Amount")%>&&range_two=<%=ranger%>&&percentageSecond=<%=percentageForDiscount2%>&&options=1&&months=1&&PageToGo=Mortgage&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>"
                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                        ավելին</a>
                                                                    <a href="MortgageClient?id=${firstDepo.productCode}&&percentageSecond=<%=percentageForDiscount2%>&&range_two=<%=ranger%>&&options=0&&months=1&&MaxAmount=<%=request.getAttribute("maxAmount")%>&&City=<%=request.getAttribute("city")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                                ...
                                                                                <div class="table">
                                                                                    <div class="table-row">
                                                                                        ...
                                                                                        <div class="table-cell text-center">
                                                                                            ...
                                                                                            <c:choose>
                                                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                                    <a href="CreditSend?ProductCode=${seconDepo.productCode}&&range=<%=request.getAttribute("Amount")%>&&range_two=<%=ranger%>&&percentageSecond=<%=percentageForDiscount2%>&&options=1&&months=1&&PageToGo=Mortgage&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>"
                                                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                                        ավելին</a>

                                                                                                    <a href="MortgageClient?id=${seconDepo.productCode}&&percentageSecond=<%=percentageForDiscount2%>&&range_two=<%=ranger%>&&options=0&&months=1&&MaxAmount=<%=request.getAttribute("maxAmount")%>&&City=<%=request.getAttribute("city")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                                                    <%--<p>
