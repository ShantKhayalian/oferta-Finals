                            ...
                            <div class="table-row">
                                ...
                                <div class="table-cell">
                                    ...
                                    <%
                                        ...
                                        float AmountMain = Integer.parseInt((String) request.getAttribute("minAmount"));//100000
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="CalculateMort" method="get" name="SortingPercentageDesc">
                            ...
                            <form action="CalculateMort" method="get" name="SortingPercentageAsec">
                        ...
                        <div class="table-cell">
                            ...
                            <span>Գումար</span>
                            <form action="CalculateMort" method="get" name="SortingTimeDescAmount">
                            ...
                            <form action="CalculateMort" method="get" name="SortingTimeAsecAmount">
                                <input name="MaxAmount" value="<%=request.getParameter("MaxAmount")%>" type="hidden">
                                <input name="City" value="<%=request.getParameter("City")%>" type="hidden">
                                <input name="Currancy" value="<%=request.getParameter("Currancy")%>" type="hidden">
                                <input name="PageToGo" value="<%=request.getAttribute("PageToGo")%>" type="hidden">
