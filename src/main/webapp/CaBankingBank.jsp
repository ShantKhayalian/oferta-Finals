                         ...
                         <div class="tooltip">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="AutoBanks" method="get" name="Delete">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="AutoBanks" method="get" name="DeleteHipotek">
                            ...
                            <ul>
                                <li>
                                  ...
                                  <form action="AutoBanks" method="get" name="DeleteConsumer">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="AutoBanks" method="get" name="DeleteCar">
                           ...
                           <%-- <form action="CompareMicro" method="get" name="MicroCompare">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="AutoBanks" method="get" name="DeleteAG">
                            ...
                            <div class="table hide-for-mb">
                                <div class="table-row head sorting">
                                    ...
                                    <div class="table-cell">
                                        ...
                                        <form action="AutoBanks" method="get" name="SortingPercentageDesc">
                                        ...
                                        <form action="AutoBanks" method="get" name="SortingPercentageAsec">
                                            <input type="hidden" name="bankId" value='<%=request.getParameter("bankId")%>'/>
