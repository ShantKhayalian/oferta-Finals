                        ...
                        <div class="table">
                            <div class="table-row">
                                ...
                                <div class="table-cell text-center">
                                    ...
                                    <a href="CreditSend?ProductCode=${SpecialConsumer.productCode}&&Per=${SpecialConsumer.ACFactual}&&months=1&&Amount=<%=request.getAttribute("range")%>&&PageToGo=AG&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&value_two=<%=request.getAttribute("minAmount")%>&&range_two=30"
                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ ավելին</a>
                                    <p>
                                        <a href="AClient?id=${SpecialConsumer.productCode}&&months=1&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getParameter("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                ...
                                                <div class="table">
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-cell">
                                                            ...
                                                            <p class="font-28 bold">${firstDepo.ACFactual}%</p>
                                                        ...
                                                        <div class="table-cell text-center last">
                                                            <p class="margin-bottom-20 show-for-mb text-left">
                                                                <a class="green-link font-12 width-icon right-icon ellipsis"
                                                                   onclick="toggleSubSuggestions()">
                                                                    <span>Ավելի Առաջարկներ</span> <li
                                                                        class="icon-arrow-down"></li>
                                                                </a>
                                                            </p>
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                    <a href="CreditSend?ProductCode=${firstDepo.productCode}&&Per=${firstDepo.ACFactual}&&months=1&&Amount=<%=request.getAttribute("range")%>&&PageToGo=AG&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&value_two=<%=request.getAttribute("minAmount")%>&&range_two=30"
                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                        ավելին</a>
                                                                    <a href="AClient?id=${firstDepo.productCode}&&months=1&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getParameter("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                                ...
                                                                                <div class="table">
                                                                                    <div class="table-row">
                                                                                        ...
                                                                                        <div class="table-cell text-center">
                                                                                            ...
                                                                                            <c:choose>
                                                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                                    <a href="CreditSend?ProductCode=${seconDepo.productCode}&&Per=${seconDepo.ACFactual}&&months=1&&Amount=<%=request.getAttribute("range")%>&&PageToGo=AG&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&value_two=<%=request.getAttribute("minAmount")%>&&range_two=30"
                                                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                                        ավելին</a>

                                                                                                    <a href="AClient?id=${seconDepo.productCode}&&months=1&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getParameter("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Mortgage"
                                                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                                                    <%--<p>
