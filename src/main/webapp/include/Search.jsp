...
<div class="search-popup" id="searchPopup">
    ...
    <div class="inner">
        ...
        <form action="SearchPageApp" method="get" onsubmit="return validate();">
            <div class="def-input int-right-icon int-outline margin-top-40">
                <i class="icon-search"></i>
                <div class="col-10 middle col search-mob-div__one">
...
<p id="demo"></p>
                ...
                <div class="col-1-2 small col search-mob-div__two">
