            ...
            <div class="inner-container large">
               ...
               <span class="logo">
                   ...
                   &lt;%&ndash; <div class="list" id="langList">
                     ...
                     <span class="compere-icon" ${requestScope.City}  >
    ...
    <div class="bg-white-dark padding-bottom-60 bank-item-page">
        <div class="inner-container">
            ...
            <div class="row row-flex flex flex-wrap credit-info">
                ...
                <div class="col-4 flex align-items-center item">
                    <span>Սպասարկման վճար</span><span>${details.ACMaxServiceFee}</span>
                </div>
                <div class="col-4 flex align-items-center item">
                    <span>Փաստաթղթեր</span><span>Անձնագիր</span>
                </div>
                <div class="col-4 flex align-items-center item">
                    <span>Վարկի գումարը</span><span>${details.ACMinAmount} - ${details.ACMaxAmount}</span>
                </div>
                <div class="col-4 flex align-items-center item">
                ...
                <div class="col-4 flex align-items-center item">
                    <span>Տեւողությունը</span><span>${details.ACMinPeriodMonth} Ամիս - ${details.ACMaxPeriodMonth} Ամիս</span>
                </div>
                <div class="col-4 flex align-items-center item">
                                ...
                                <div class="total-info">
                                    <div class="flex  margin-bottom-15">
                                        <div>
                                            ...
                                            %>
                                            <%
                                                percent = Double.parseDouble(String.valueOf(request.getAttribute("ACFactual")));
                                        ...
                                        <div>
                                            <p>Ամսական վճար</p>
                                            <c:set var="currancy" value="${requestScope.PageCurrancy}"/>
                                            <c:choose>
                ...
                <div class="modal-body scroll" id="menu2">
                    <div class="clone-pdf">
                        ...
                        <%!
                            ...
                            int AmountOfLoan;
                            int MonthsToPay;
                            double percentageOfLoan;
                            int AmountToPaycalc;
                            int MainAmount;
                            int loanWithMainAMount;
                        ...
                        <%!
                            int vjarumDogosakumar(float Amount, double Percentage, int month) {
                                ...
                                float powerNumber = (float) Math.pow(addNumber1, -month);//enthanur avelatsadz himnagan kumari dogose
                                float minuesOne = (1 - powerNumber);
                                collect1 = (int) ((Amount * percentage)/month);
                                first2Ag += collect1;
                                result = (int) (Amount * percentage);
                                return result;
                            }
                        %>
                        <%!
                        ...
                        %>
                            <%!
                                static int first2Ag;
                                static int second2Ag;
                                static int third2Ag;
                            %>
                            <%!
                                int calculatThirdResult(){
                                    int results = calculatePercentage(AmountOfLoan, percentageOfLoan, MonthsToPay)-vjarumDogosakumar(AmountOfLoan, percentageOfLoan, MonthsToPay);
                                    second2Ag += results;
                                    return results;
                                }
                            %>
                        ...
                        <div class="table-row">
                            ...
                            <div class="table-cell">
                                <span><fmt:formatNumber type="number" maxFractionDigits="3"
                                                        value='<%=calculatThirdResult()%>'/></span>
                            </div>
                            <div class="table-cell">
                                <span><fmt:formatNumber type="number" maxFractionDigits="3"
                        ...
                        <div class="table-row bottom">
                            ...
                            <div class="table-cell"><span><fmt:formatNumber type="number" maxFractionDigits="3"
                                                                            value='<%=second2Ag%>'/></span>
                            </div>
                            <div class="table-cell"><span><fmt:formatNumber type="number" maxFractionDigits="3"
                                                                            value='<%=third2Ag/3%>'/></span>
                            </div>
                        </div>
                        <div class="table-row head">
                            <div class="table-cell small"><span>Ամիս</span></div>
                    ...
                    <div class="clone-pdf">
                        ...
                        <%!
                            int calculatePercentage2(float Amount, double Percentage, int month) {
                                int newAmount = (int) (Amount - AmountToPaycalc);
                                //MainAmount = (int) Amount;
                                ...
                                float result = (int) (AmountToPaycalc / minuesOne);
                                loanWithMainAMount = (int) (AmountToPaycalc / minuesOne);
                                System.out.println("loanWithMainAMount " + loanWithMainAMount);
                        ...
                        <%!
                            int vjarumDogosakumar2(float Amount, double Percentage, int month) {
                                ...
                                float minuesOne = (1 - powerNumber);
                                System.out.println("minuesOne " + minuesOne);
                                result = (int) (calculateNvazoxDogosHimnaganKumar(Amount) * percentage);
                        ...
                        <%!
                            int calculateNvazoxDogosHimnaganKumar(float AmountOfLoan) {
                                int amount = (int) (AmountOfLoan - (calculatePercentage2(AmountOfLoan, percentageOfLoan, MonthsToPay) - vjarumDogosakumar(AmountOfLoan, percentageOfLoan, MonthsToPay)));
                                return amount;
                            }
                        %>
                        <%!
                            int calculatSecond(int i) {
                                int result;
                                result = calculatThird() - vjarumDogosakumar2(calculatVargiMnatsort2(AmountOfLoan, i), percentageOfLoan, MonthsToPay);
                        ...
                        <div class="table-row">
                            <div class="table-cell small"><span><%=i + 1%></span></div>
                            <div class="table-cell">
                                <span> <fmt:formatNumber type="number" maxFractionDigits="3" value='<%=calculatVargiMnatsort2(AmountOfLoan,i)%>'/></span>
                            </div>
                            <div class="table-cell large">
                                <span> <fmt:formatNumber type="number" maxFractionDigits="3"
                                                         value='<%=vjarumDogosakumar2(calculatVargiMnatsort2(AmountOfLoan,i), percentageOfLoan, MonthsToPay) %>'/></span>
                            </div>
                            <%-- <div class="table-cell">
                                 <span><fmt:formatNumber type="number" maxFractionDigits="3" value='<%=calculatePercentage2(AmountOfLoan, percentageOfLoan, MonthsToPay)-vjarumDogosakumar(AmountOfLoan, percentageOfLoan, MonthsToPay) %>'/></span>
                             </div>--%>
                            <div class="table-cell">
                                <span><fmt:formatNumber type="number" maxFractionDigits="3"
                        ...
                        <div class="table-row bottom">
                            ...
                            <div class="table-cell"><span><fmt:formatNumber type="number" maxFractionDigits="3"
                                                                            value='<%=finalCaculat2%>'/></span>
                            </div>
                            <div class="table-cell"><span><fmt:formatNumber type="number" maxFractionDigits="3"
                                                                            value='<%=finalCaculat3%>'/></span>
                            </div>
                        </div>
                        <div class="table-row head">
                            <div class="table-cell small"><span>Ամիս</span></div>
