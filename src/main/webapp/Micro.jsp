            ...
            <div class="inner-container large">
              ...
              <span class="logo">
                   <a href="App?PageLanguage=${requestScope.Pagelanguage}">  <img
                           src="${requestScope.getContextPath}/images/oferta1.jpg"
                           alt=""/></a>
               </span>
        ...
        <div class="bg" style="background-image: url('../images/6.jpg')">
            <div class="inner-container info-container">
                ...
                <div class="row-md clearfix">
                    <form name="main" action="CalculatMocri" method="get">
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="MicroClient" method="get" name="SortingPercentageDesc">
                            ...
                            <form action="MicroClient" method="get" name="SortingPercentageAsec">
                        ...
                        <div class="table-cell">
                            ...
                            <span>Գումար</span>
                            <form action="MicroClient" method="get" name="SortingPercentageDescAmount">
                            ...
                            <form action="MicroClient" method="get" name="SortingPercentageAsecAmount">
