                         ...
                         <div class="tooltip">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="CardMoreDetail" method="get" name="Delete">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="CardMoreDetail" method="get" name="DeleteHipotek">
                            ...
                            <ul>
                                <li>
                                  ...
                                  <form action="CardMoreDetail" method="get" name="DeleteConsumer">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="CardMoreDetail" method="get" name="DeleteCar">
                           ...
                           <%-- <form action="CompareMicro" method="get" name="MicroCompare">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="CardMoreDetail" method="get" name="DeleteAG">
