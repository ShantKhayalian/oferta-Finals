                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="CalculatMocri" method="get" name="SortingPercentageDesc">
                            ...
                            <form action="CalculatMocri" method="get" name="SortingPercentageAsec">
                        ...
                        <div class="table-cell">
                           <%-- <c:set value="${requestScope.arrow2}" var="arrow2"/>
                            ...
                            <span>Գումար</span>
                           <%-- <form action="CalculatMocri" method="get" name="SortingTimeDescAmount">
                            ...
                            <form action="CalculatMocri" method="get" name="SortingTimeAsecAmount">
