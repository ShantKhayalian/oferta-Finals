...
public class CommentDaoComtroller {
    ...
    public int updateAgInData(Comments comments, int productCode) throws SQLException {
        ...
        try {
            ...
            String sql = "UPDATE `commentscontroller`  " +
                    "SET Comment1_Am=?,Comment2_Am=?,Comment3_Am=?,Comment1_En=?,Comment2_En=?,Comment3_En=?," +
                    "Comment1_Ru=?,Comment2_Ru=?,Comment3_Ru=?  " +
    ...
    private void setStatment(Comments comments, PreparedStatement statement) throws SQLException {
        ...
        statement.setString(4, comments.getComment1_En());
        statement.setString(5, comments.getComment2_En());
        statement.setString(6, comments.getComment3_En());
        statement.setString(7, comments.getComment1_Ru());
        statement.setString(8, comments.getComment2_Ru());
        statement.setString(9, comments.getComment3_Ru());
