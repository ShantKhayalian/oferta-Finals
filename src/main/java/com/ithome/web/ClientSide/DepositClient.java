...
public class DepositClient extends HttpServlet {
    ...
    private DepositComparing CreateObjects() {
        return new DepositComparing(ID, sessionId, Integer.parseInt(amoutFiltered), 30, BankId, productName, DEquippingPossibilitiesid, DEarlierWithdrawalAmountid, DAutoExtendPeriodid, DCapitalizationPercentid, percentage);
    }
